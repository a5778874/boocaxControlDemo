...
public class PacketBuilder {
	 ...
	 * @return
	 */
	public static MsgPacket obtainAIUIConfPacket(JSONObject config){
		try {			
			JSONObject ret = new JSONObject();
			ret.put("type", "aiui_cfg");
			ret.put("content", config);
	 ...
	 * @return
	 */
	public static MsgPacket obtainVolValuePacket(int vol_value){
		try {
			JSONObject content = new JSONObject();
			content.put("vol_value", vol_value);
	 ...
	 *	}
	 */
	public static MsgPacket obtainVolStatusReqPacket(){
		try {
			JSONObject content = new JSONObject();
			content.put("query", "volume");
	...
	public static MsgPacket obtainAIUICtrPacket(int msgType, int arg1, int arg2, String params){
		return obtainAIUICtrPacket(msgType, arg1, arg2, params, null);
	}
	...
	public static MsgPacket obtainAIUICtrPacket(int msgType, int arg1, int arg2, String params, byte[] data){
		try {
			...
			content.put("params", params==null? "":params);
	 ...
	 * @return
	 */
	public static MsgPacket obtainTTSStartPacket(String ttsText, Map<String, String> params){
		try {
